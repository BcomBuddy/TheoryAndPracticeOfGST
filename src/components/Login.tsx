      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Sign in to access the GST Simulator
            </p>
          </div>
          ...
          <button
            ...
            className="w-full bg-white text-gray-700 py-3 px-4 rounded-lg font-medium border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors flex items-center justify-center"
          >
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-500">
            GST Simulator for B.com Students
          </p>
        </div>
      </div>
